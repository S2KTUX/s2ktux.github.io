...
assert.ok(allHtml.every(path => !/^(?:node_modules|playwright-report|test-results)\//.test(sitePath(path))), 'La auditoría no debe inspeccionar dependencias ni informes generados');
