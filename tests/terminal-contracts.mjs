...
const contracts = [
  ...
  ['Editor write protection and workflows', /editorRemember/.test(core) && /E212: No se puede abrir/.test(core) && /confirmExit/.test(core) && /lastSearch/.test(core) && /GNU nano 5\.6\.1/.test(core)],
